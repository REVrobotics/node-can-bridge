...
const runtimeArtifactsPath = {
    win: 'prebuilds/node_canbridge-win32-x64',
    osx: 'prebuilds/node_canbridge-darwin-osxuniversal',
    linux: 'prebuilds/node_canbridge-linux-x64',
    linuxArm: 'prebuilds/node_canbridge-linux-arm64',
    linuxArm32: 'prebuilds/node_canbridge-linux-arm32'
};
const tempDir = 'temp';
